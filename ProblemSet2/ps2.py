...
class RectangularRoom(object):
    ...
    def cleanTileAtPosition(self, pos):
        ...
        self.tiles.append((math.floor(pos.getX()), math.floor(pos.getY())))
    ...
    def getRandomPosition(self):
        ...
        """
        return Position(math.floor(random.random() * self.width), math.floor(random.random() * self.height))
...
#print  runSimulation(1, .9, 10, 10, 1, 30, StandardRobot)
...
#       (... your call here ...)
#
#showPlot1('Robot cleaning 80%', 'Number of Robots', 'Time-steps')
#
...
#       (... your call here ...)
#
showPlot2('Time It Takes Two Robots To Clean 80% Of Variously Shaped Rooms', 'Aspect Ration', 'Time-steps')